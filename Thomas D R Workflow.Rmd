...
ouvre une parenthèse avec tt les charactéristique des chunk
...
fastqc PROGRAMME 
le score fret -> casse jaune, c'est la probabilité de se tromper -> freq score de 10 -> 1 chance sur 10 de se tromper fret 20 = 1 chance sur 1000 ???
...
freq score de 10 -> 1 chance sur 10 de se tromper
per sequence quality score -> y la fréquence des read et x c'est le fret score moyen d'une reads et la fréquence de ses reads. le pic doit etre a droite en gros
...
# pareil mais faut qu'il soit présent dans 3 réplicats a chaque fois
?unite
...
dn.dss= calculateDiffMethDSS(meth, adjust = "SLIM" )# Ne montre rien, rien qui "survie" 
